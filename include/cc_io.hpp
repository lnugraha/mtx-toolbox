...
void cc_data_read ( char *prefix, int ncc, int n, int icc[], int ccc[], double acc[] );
...
void cc_print_some ( int i_min, int i_max, int j_min, int j_max, int ncc, int n, int icc[], int ccc[], double acc[], char *title );

void cc_write ( char *prefix, int ncc, int n, int icc[], int ccc[], double acc[] );
